const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/style-CGnYBJct.css"])))=>i.map(i=>d[i]);
(function polyfill() {
...
const require$$0 = /* @__PURE__ */ getDefaultExportFromCjs$1(reactExports);
var client = { exports: {} };
...
function requireReactDomClient_production() {
  ...
  function updateOptions(node, multiple2, propValue, setDefaultSelected) {
    node = node.options;
    if (multiple2) {
      multiple2 = {};
      for (var i = 0; i < propValue.length; i++)
        multiple2["$" + propValue[i]] = true;
      for (propValue = 0; propValue < node.length; propValue++)
        i = multiple2.hasOwnProperty("$" + node[propValue].value), node[propValue].selected !== i && (node[propValue].selected = i), i && setDefaultSelected && (node[propValue].defaultSelected = true);
    } else {
      ...
      for (i = 0; i < node.length; i++) {
        ...
        null !== multiple2 || node[i].disabled || (multiple2 = node[i]);
      }
      null !== multiple2 && (multiple2.selected = true);
    }
  }
  ...
  function prepareFreshStack(root2, lanes) {
    ...
    -1 !== timeoutHandle && (root2.timeoutHandle = -1, cancelTimeout2(timeoutHandle));
  ...
  var scheduleTimeout = "function" === typeof setTimeout ? setTimeout : void 0, cancelTimeout2 = "function" === typeof clearTimeout ? clearTimeout : void 0, localPromise = "function" === typeof Promise ? Promise : void 0, scheduleMicrotask = "function" === typeof queueMicrotask ? queueMicrotask : "undefined" !== typeof localPromise ? function(callback) {
...
function createGridComponent(_ref2) {
  var _class;
  var getColumnOffset2 = _ref2.getColumnOffset, getColumnStartIndexForOffset2 = _ref2.getColumnStartIndexForOffset, getColumnStopIndexForStartIndex2 = _ref2.getColumnStopIndexForStartIndex, getColumnWidth2 = _ref2.getColumnWidth, getEstimatedTotalHeight2 = _ref2.getEstimatedTotalHeight, getEstimatedTotalWidth2 = _ref2.getEstimatedTotalWidth, getOffsetForColumnAndAlignment2 = _ref2.getOffsetForColumnAndAlignment, getOffsetForRowAndAlignment2 = _ref2.getOffsetForRowAndAlignment, getRowHeight2 = _ref2.getRowHeight, getRowOffset2 = _ref2.getRowOffset, getRowStartIndexForOffset2 = _ref2.getRowStartIndexForOffset, getRowStopIndexForStartIndex2 = _ref2.getRowStopIndexForStartIndex, initInstanceProps2 = _ref2.initInstanceProps, validateProps2 = _ref2.validateProps;
  return _class = /* @__PURE__ */ (function(_PureComponent) {
    ...
    function Grid(props) {
      ...
      _this._getItemStyle = function(rowIndex, columnIndex) {
        ...
        var itemStyleCache = _this._getItemStyleCache(columnWidth, direction, rowHeight);
...
function requireLodash_uniqby() {
  if (hasRequiredLodash_uniqby) return lodash_uniqby.exports;
  ...
  return lodash_uniqby.exports;
}
var lodash_uniqbyExports = requireLodash_uniqby();
...
const PACKAGE_BASE_URL = "https://raw.githubusercontent.com/noeGnh/react-icon-picker/master/packages/react-icon-picker";
const ICONS_LIST_URL = `${PACKAGE_BASE_URL}/icons-list.json`;
const ICONS_ASSETS_URL = `${PACKAGE_BASE_URL}/src/assets/sicons`;
const ICONS_STORAGE_KEY = "r3ip-icons-list";
function useIconsLoader() {
  const [iconsList, setIconsList] = reactExports.useState([]);
  ...
  const prepareData = reactExports.useCallback(async () => {
    let iconsRawList = [];
    try {
...
const reactIconPickerIcon = "_reactIconPickerIcon_hpd6d_1";
const styles$1 = {
  reactIconPickerIcon
};
const Icon = ({ data, color, size: size2 = 24, style, ...rest }) => {
  ...
  const computedSize = typeof size2 === "number" ? `${size2}px` : size2 || "unset";
...
const r3ipCustomSelect = "_r3ipCustomSelect_7h5gk_1";
const r3IpCustomSelect = "_r3ipCustomSelect_7h5gk_1";
const r3ipSelected = "_r3ipSelected_7h5gk_9";
const r3IpSelected = "_r3ipSelected_7h5gk_9";
const r3ipSmall = "_r3ipSmall_7h5gk_22";
const r3IpSmall = "_r3ipSmall_7h5gk_22";
const r3ipMedium = "_r3ipMedium_7h5gk_31";
const r3IpMedium = "_r3ipMedium_7h5gk_31";
const r3ipLarge = "_r3ipLarge_7h5gk_40";
const r3IpLarge = "_r3ipLarge_7h5gk_40";
const multiple = "_multiple_7h5gk_49";
const item = "_item_7h5gk_54";
const placeholder = "_placeholder_7h5gk_59";
const open = "_open_7h5gk_63";
const disabled = "_disabled_7h5gk_107";
const r3ipDropdown = "_r3ipDropdown_7h5gk_112";
const r3IpDropdown = "_r3ipDropdown_7h5gk_112";
const r3ipDropdownOpen = "_r3ipDropdownOpen_7h5gk_121";
const r3IpDropdownOpen = "_r3ipDropdownOpen_7h5gk_121";
const r3ipItems = "_r3ipItems_7h5gk_127";
const r3IpItems = "_r3ipItems_7h5gk_127";
const r3ipGridItem = "_r3ipGridItem_7h5gk_142";
const r3IpGridItem = "_r3ipGridItem_7h5gk_142";
const active = "_active_7h5gk_157";
const r3ipSearch = "_r3ipSearch_7h5gk_161";
const r3IpSearch = "_r3ipSearch_7h5gk_161";
const r3ipEmpty = "_r3ipEmpty_7h5gk_191";
const r3IpEmpty = "_r3ipEmpty_7h5gk_191";
const defaultText = "_defaultText_7h5gk_203";
const r3ipDark = "_r3ipDark_7h5gk_208";
const r3IpDark = "_r3ipDark_7h5gk_208";
const styles = {
  r3ipCustomSelect,
  r3IpCustomSelect,
...
const Picker = ({
  ...
  const [scrollerWidth, setScrollerWidth] = reactExports.useState(0);
    ...
    return uniqBy(
      uniqBy(
        iconsList.filter((icon) => {
          const belongsToIconLibs = typeof iconLibrary === "string" && icon.library === iconLibrary || Array.isArray(iconLibrary) && iconLibrary.includes(icon.library) || iconLibrary === "all";
          const belongsToUserSearch = !searchQuery || icon.name?.toLowerCase().includes(searchQuery.toLowerCase());
          const belongsToIncludes = !includeIcons || !includeIcons.length || includeIcons.includes(icon.name);
          const belongsToIncludeSearch = !includeSearch || icon.name?.toLowerCase().includes(includeSearch.toLowerCase());
          const doesNotBelongsToExcludes = !excludeIcons || !excludeIcons.length || !excludeIcons.includes(icon.name);
          const doesNotBelongsToExcludeSearch = !excludeSearch || !icon.name?.toLowerCase().includes(excludeSearch.toLowerCase());
  ...
  const getSvgCodeOrUrl = reactExports.useCallback(
    (val) => {
      return valueType === "name" && !isSVG(val) ? iconsList?.find((icon) => icon.name === val)?.svgUrl || "" : val;
    },
    [valueType, iconsList]
  );
  const isIconSelected = reactExports.useCallback(
    (icon) => {
      if (multiple2) {
        if (value && Array.isArray(value) && value.length) {
          return value.findIndex((i) => i === getValue(icon)) > -1;
        }
        return false;
      } else {
  ...
  const onSelected = reactExports.useCallback(
      ...
      if (icon) {
        if (multiple2) {
          if (value && Array.isArray(value) && value.length) {
            ...
            const index = value.findIndex((i) => i === getValue(icon));
            if (index > -1) {
    ...
    [multiple2, value, onChange, getValue, multipleLimit, clearable]
  );
  const handleToggle = () => {
    if (!disabled2) {
      setOpen(!open2);
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Icon,
          {
            data: item2.svgUrl,
            size: 24,
            color: isIconSelected(item2) ? selectedIconColor : theme === "dark" ? "#e5e7eb" : "#222"
          }
        )
      }
    );
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `${styles.r3ipSelected} ${open2 ? styles.open : ""} ${disabled2 ? styles.disabled : ""}`,
            onClick: handleToggle,
            children: !multiple2 && value || multiple2 && Array.isArray(value) && value.length ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: multiple2 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.multiple, children: [
              Array.isArray(value) && value.map((val, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(require$$0.Fragment, { children: i < selectedItemsToDisplay && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.item, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Icon,
                {
                  ...
                  onClick: (e) => {
                    e.stopPropagation();
                    onSelected(
                      iconsList?.find((icon) => getValue(icon) === val)
                    );
                  }
                }
              ) }) }, i)),
              Array.isArray(value) && value.length > selectedItemsToDisplay && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.item, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("b", { children: [
                "+",
                value.length - selectedItemsToDisplay
              ] }) })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              Icon,
              {
            ...
            ) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.placeholder, children: placeholder2 })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${styles.r3ipDropdown} ${open2 ? styles.r3ipDropdownOpen : ""}`, children: [
          displaySearch && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.r3ipSearch, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
              name: "search",
          ...
          filteredIcons && filteredIcons.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: scrollerRef, className: styles.r3ipItems, children: scrollerWidth > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            FixedSizeGrid,
            {
              columnCount,
          ...
          ) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.r3ipEmpty, children: emptySlot || /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.defaultText, children: /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: emptyText }) }) })
        ] })
      ]
    }
  );
...
const App = () => {
  ...
  const [clearable, setClearable] = reactExports.useState(false);
  const [multipleSelection, setMultipleSelection] = reactExports.useState(false);
  const [selectedLibraries, setSelectedLibraries] = reactExports.useState(["fa"]);
  const [inputSize, setInputSize] = reactExports.useState("medium");
  const isSelected = (lib) => selectedLibraries.includes(lib);
  const toggleSelectedLibraries = (lib) => {
    setSelectedLibraries(
      (prev) => prev.includes(lib) ? prev.filter((l) => l !== lib) : [...prev, lib]
    );
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports$1.jsxs("section", { className: "container", children: [
    /* @__PURE__ */ jsxRuntimeExports$1.jsx("h2", { children: "D E M O" }),
    /* @__PURE__ */ jsxRuntimeExports$1.jsx("h4", { children: "Icon libraries to display" }),
    /* @__PURE__ */ jsxRuntimeExports$1.jsx("div", { className: "buttons", children: ICON_LIBRARIES.map((lib) => /* @__PURE__ */ jsxRuntimeExports$1.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports$1.jsx("h4", { children: "Input sizes" }),
    /* @__PURE__ */ jsxRuntimeExports$1.jsx("div", { className: "buttons", children: ["small", "medium", "large"].map((size2) => /* @__PURE__ */ jsxRuntimeExports$1.jsx(
      "div",
      {
        className: `button ${inputSize === size2 ? "selected" : ""}`,
        onClick: () => setInputSize(size2),
        children: size2.charAt(0).toUpperCase() + size2.slice(1)
      },
      size2
    )) }),
    /* @__PURE__ */ jsxRuntimeExports$1.jsx("h4", { children: "Other options" }),
    /* @__PURE__ */ jsxRuntimeExports$1.jsxs("div", { className: "buttons", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports$1.jsx(
        "div",
        {
          ...
          children: "Make clearable"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports$1.jsx("hr", {}),
    /* @__PURE__ */ jsxRuntimeExports$1.jsx(
      Picker,
      {
        value: selection,
...
clientExports.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports$1.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports$1.jsx(App, {}) })
);
